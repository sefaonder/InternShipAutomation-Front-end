...
const ConfidentalReportAdd = ({ confidentalReport, confidentalReportId }) => {
  ...
  const validationSchema = yup.object({
    ...
    company_name: yup.string().required('Bu alan zorunludur').max(100, 'Bu Alan En Fazla 100 Karakter Olabilir.'),
    address: yup.string().required('Bu alan zorunludur').max(100, 'Bu Alan En Fazla 100 Karakter Olabilir.'),
    ...
    reg_number: yup.string().optional('Bu alan zorunludur').nullable(),
    auth_tc_number: yup
      .string()
      .required('Bu Alan')
